...
| `ticker` | string | all | Holdings of a specific security. |
| `filer_cik` | string | all | Holdings of a specific manager (by CIK). |
| `report_period_gte` | date | - | Report period on or after. |
| `report_period_lte` | date | - | Report period on or before. |
