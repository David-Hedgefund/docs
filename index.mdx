...
<Frame>
  <img className="mx-auto block dark:hidden" style={{ width: "100%", maxWidth: "560px" }} src="/images/how-it-works-light.svg" alt="David builds the worlds, you browse the library, pick a scenario, and query the data like a real API." />
  <img className="mx-auto hidden dark:block" style={{ width: "100%", maxWidth: "560px" }} src="/images/how-it-works-dark.svg" alt="David builds the worlds, you browse the library, pick a scenario, and query the data like a real API." />
</Frame>
